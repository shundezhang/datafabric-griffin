...
public interface BlockModeConstants {
    ...
    /** Data block is the End of Data(EOD). */
    static final int DESC_CODE_EOD = 8;

    /** Sender will close the data connection. */
    static final int DESC_CODE_CLOSE = 4;
    
    /** header length for E block mode. */
    static final int EBLOCK_HEADER_LENGTH=17;
