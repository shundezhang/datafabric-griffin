 ...
 * 
 * Created: 2010-09-19 Guy K. Kloss <guy.kloss@aut.ac.nz>
 * Changed:
 * 
...
public class GridfsFileSystemConnectionImpl implements FileSystemConnection {
    ...
    public GridfsFileSystemConnectionImpl(String serverName,
        ...
        if (serverPort == 0) {
            serverPort = GridfsConstants.DEFAULT_MONGO_PORT;
        }
        if (serverName == null) {
            serverName = GridfsConstants.DEFAULT_MONGO_HOST;
        }
        if (bucketName == null) {
        ...
        try {
            ...
            if (user != null && !user.isEmpty()) {
                ...
                log.debug("Authenticated at MongoDB with user \"" + user + "\".");
            }
